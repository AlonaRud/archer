...
namespace CBS
{
    public class TableProfileAssistant
    {
        ...
        public static async Task<ExecuteResult<Azure.Response>> UpdateProfileStatisticsAsync(string profileID, Dictionary<string, StatisticEntryInfo> statisitcsToUpdate)
        {
            ...
            foreach (var updateEntry in statisitcsToUpdate)
            {
                statistics[updateEntry.Key] = updateEntry.Value;
            }
