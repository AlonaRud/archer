...
namespace CBS
{
    public class FriendsModule : BaseAzureModule
    {
        ...
        private static readonly string  FriendsOutgoingTag = "Outgoing";

        [Function(AzureFunctions.GetFriendsListMethod)]
        public static async Task<dynamic> GetFriendsListTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetRequestedFriendsListMethod)]
        public static async Task<dynamic> GetRequestedFriendsListTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionGetFriendsListRequest>();
        ...
        [Function(AzureFunctions.GetOutgoingRequestsMethod)]
        public static async Task<dynamic> GetOutgoingRequestsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionGetFriendsListRequest>();
            ...
            var getResult = await GetOutgoingRequestsAsync(profileID, constraints);
            if (getResult.Error != null)
            {
                return ErrorHandler.ThrowError(getResult.Error).AsFunctionResult();
            }
        ...
        [Function(AzureFunctions.SendFriendRequestMethod)]
        public static async Task<dynamic> SendFriendRequestTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.CheckFriendshipMethod)]
        public static async Task<dynamic> CheckFriendshipTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionFriendsRequest>();
        ...
        [Function(AzureFunctions.AcceptFriendRequestMethod)]
        public static async Task<dynamic> AcceptFriendTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionFriendsRequest>();
        ...
        [Function(AzureFunctions.DeclineFriendRequestMethod)]
        public static async Task<dynamic> DeclineFriendRequestTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionFriendsRequest>();
        ...
        [Function(AzureFunctions.RemoveFriendMethod)]
        public static async Task<dynamic> RemoveFriendTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionFriendsRequest>();
        ...
        [Function(AzureFunctions.GetFriendsBadgeMethod)]
        public static async Task<dynamic> GetFriendsBadgeTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetSharedFriendsMethod)]
        public static async Task<dynamic> GetSharedFriendsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        public static async Task<ExecuteResult<FunctionFriendsResult>> GetOutgoingRequestsAsync(string profileID, CBSProfileConstraints constraints)
        {
            var getMetaResult = await GetFriendsMetaAsync();
            if (getMetaResult.Error != null)
            {
            ...
            var friendsList = friendsResult.Result;
            var outgoingRequests = friendsList.Where(x=>x.GetTag() == FriendsOutgoingTag);
            var outgoingIDs = outgoingRequests.Select(x=>x.FriendPlayFabId).ToArray();
            var profileDetailsResult = await TableProfileAssistant.GetProfilesDetailsAsync(outgoingIDs, constraints);
            if (profileDetailsResult.Error != null)
            {
                return ErrorHandler.ThrowError<FunctionFriendsResult>(profileDetailsResult.Error);
            }
        ...
        public static async Task<ExecuteResult<FunctionFriendRequestResult>> SendFriendsRequestAsync(string profileID, string friendID)
        {
            ...
            var setOutgoingTagRequest = new SetFriendTagsRequest {
                PlayFabId = profileID,
                FriendPlayFabId = friendID,
                Tags = new List<string>() {FriendsOutgoingTag}
            };
            
            var tagOutgoingResult = await FabServerAPI.SetFriendTagsAsync(setOutgoingTagRequest);
            if (tagOutgoingResult.Error != null)
            {
                return ErrorHandler.ThrowError<FunctionFriendRequestResult>(tagOutgoingResult.Error);
            }
